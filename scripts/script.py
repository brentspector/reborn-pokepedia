...
tmLocations = {
    "Workup": {"location": "Rhodochrine Jungle", "point": "Adrienn", "method": "Up the Right Bridge"},
    "Dragonclaw": {"location": "", "point": "", "method": ""},
    "Psyshock": {"location": "Agate City", "point": "Hardy", "method": "Bee 500 Pokedex Event"},
    "Calmmind": {"location": "", "point": "", "method": ""},
    "Roar": {"location": "Ametrine Mountain", "point": "Ciel", "method": "Ametrine Mountain Puzzle"},
    "Toxic": {"location": "Peridot Ward", "point": "Adrienn", "method": "Simon ID Tag Event"},
    "Hail": {"location": "North Aventurine Woods", "point": "Radomus", "method": "Aventurine Woods Puzzle"},
    "Bulkup": {"location": "Tourmaline Desert", "point": "Titania", "method": "Search Desert"},
    "Venoshock": {"location": "Byxbysion Wasteland", "point": "Aya", "method": "Mr. Bigglesworth Event"},
    "Hiddenpower": {"location": "Tanzan Cove", "point": "Radomus", "method": "Noel Prize"},
    "Sunnyday": {"location": "7th Street", "point": "Luna", "method": "Side with Magma Gang or Beat Maxwell"},
    "Taunt": {"location": "Water Treatment Center", "point": "Adrienn", "method": "GUM Room Puzzle"},
    "Icebeam": {"location": "", "point": "", "method": ""},
    "Blizzard": {"location": "", "point": "", "method": ""},
    "Hyperbeam": {"location": "Spinal Town", "point": "Amaria", "method": "Defeat McKrezzy During Mega Ring Event"},
    "Lightscreen": {"location": "Azurine Lake", "point": "Adrienn", "method": "Search Sunrise Area Underwater"},
    "Protect": {"location": "Peridot Ward", "point": "Adrienn", "method": "Beat Bet Guy in Blackstream Shelter"},
    "Raindance": {"location": "7th Street", "point": "Luna", "method": "Side with Aqua Gang or Beat Archer"},
    "Roost": {"location": "1R253 Scrapyard", "point": "Titania", "method": "1R253 Scrapyard Puzzle"},
    "Safeguard": {"location": "Rhodochrine Jungle", "point": "Taka/ZEL/Pulse Tangrowth 3", "method": "Search Totem Area"},
    "Frustration": {"location": "Celestinine Cascade", "point": "T3RR4", "method": "Search 1F Upper Left"},
    "Solarbeam": {"location": "Beryl Ward", "point": "Taka/ZEL/Pulse Tangrowth 3", "method": "Beryl Library Bookshelf Puzzle"},
    "Smackdown": {"location": "Citrine Mountain", "point": "Ciel", "method": "Search 3F Lower Right"},
    "Thunderbolt": {"location": "Obsidia Ward", "point": "Adrienn", "method": "Magic Square Puzzle"},
    "Thunder": {"location": "", "point": "", "method": ""},
    "Earthquake": {"location": "", "point": "", "method": ""},
    "Return": {"location": "Tourmaline Desert", "point": "Titania", "method": "Search Drained Oasis Upper Right"},
    "Leechlife": {"location": "Azurine Lake", "point": "Adrienn", "method": "Search Fairview 1 House Underwater"},
    "Psychic": {"location": "Route 4", "point": "Hardy", "method": "Search Glass Workstation B2F"},
    "Shadowball": {"location": "Opal Ward", "point": "Hardy", "method": "Starter Pokemon Egg Event"},
    "Brickbreak": {"location": "Agate Circus", "point": "Charlotte", "method": "Samson Prize"},
    "Doubleteam": {"location": "Citrine Mountain", "point": "Shade", "method": "Search Citrine Mountain"},
    "Reflect": {"location": "Rhodochrine Jungle", "point": "Adrienn", "method": "Search Cage with Silvon Scope"},
    "Sludgewave": {"location": "Byxbysion Wasteland", "point": "Serra", "method": "Aya Prize"},
    "Flamethrower": {"location": "Calcenon City", "point": "T3RR4", "method": "Charlotte Prize"},
    "Sludgebomb": {"location": "", "point": "", "method": ""},
    "Sandstorm": {"location": "Water Treatment Center", "point": "Ciel", "method": "Search Onyx Water Grid"},
    "Fireblast": {"location": "", "point": "", "method": ""},
    "Rocktomb": {"location": "Water Treatment Center", "point": "Ciel", "method": "Search Central Obsidia Water Grid"},
    "Aerialace": {"location": "Azurine Lake", "point": "Adrienn", "method": "Pyukumuku King Event"},
    "Torment": {"location": "Apophyll Cave", "point": "Serra", "method": "Search 3F Upper Right"},
    "Facade": {"location": "Onyx Ward", "point": "Florina", "method": "Game Corner Prize"},
    "Flamecharge": {"location": "Chrysolia Spring", "point": "Adrienn", "method": "Search B1F Lower Left Sauna"},
    ...
    "Steelwing": {"location": "Jasper Ward", "point": "Adrienn", "method": "Crystal Ball Event"},
    "Focusblast": {"location": "Apophyll Beach", "point": "Hardy", "method": "Rock Climb Near Pyrous Mountain"},
    "Energyball": {"location": "", "point": "", "method": ""},
    "Falseswipe": {"location": "Spinal Town", "point": "Serra", "method": "Search Voclain Estate Left Room Upstairs"},
    "Scald": {"location": "Celestinine Cascade", "point": "Hardy", "method": "Amaria Prize"},
    "Fling": {"location": "Celestinine Mountain", "point": "Ciel", "method": "Search B2F Upper Hill"},
    "Chargebeam": {"location": "Peridot Ward", "point": "ZEL/Pulse Tangrowth 1", "method": "Julia Prize"},
    "Skydrop": {"location": "Water Treatment Center", "point": "Adrienn", "method": "Search Control Office Room"},
    "Brutalswing": {"location": "Pyrous Mountain", "point": "Serra", "method": "Search B1F Right Side"},
    "Quash": {"location": "Obsidia Slums", "point": "ZEL/Pulse Tangrowth 1", "method": "Search 2F Top Right"},
    "Willowisp": {"location": "Mirage Tower", "point": "Titania", "method": "Search Chosen Room Upper Right"},
    "Acrobatics": {"location": "Agate Circus", "point": "Adrienn", "method": "Talk to Ringmaster After Defeating Ciel"},
    "Embargo": {"location": "Grand Stairway", "point": "Shelly", "method": "Search B2F Ascending Left Path"},
    "Explosion": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Purchase from Street Rat Merchant"},
    "Shadowclaw": {"location": "Yureyu Power Plant", "point": "Kiki", "method": "Shade Prize"},
    "Payback": {"location": "Byxbysion Wasteland", "point": "Aya", "method": "Search Byxbysion Grotto Middle Fork"},
    "Smartstrike": {"location": "Celestinine Mountain", "point": "Ciel", "method": "Search 4F Up the Area"},
    "Gigaimpact": {"location": "Coral Lighthouse", "point": "Adrienn", "method": "Search Lighthouse Upper Area"},
    "Rockpolish": {"location": "Celestinine Mountain", "point": "Ciel", "method": "Celestinine Mountain Ice Puzzle"},
    "Auroraveil": {"location": "Spinal Town", "point": "Noel", "method": "Serra Prize"},
    "Stoneedge": {"location": "Sugiline Ruin", "point": "Titania", "method": "Search 1F Left of Arceus Statue Upper Middle"},
    "Voltswitch": {"location": "", "point": "", "method": ""},
    "Thunderwave": {"location": "Route 4", "point": "Hardy", "method": "Search Mechanic Shed"},
    "Gyroball": {"location": "Iolia Valley", "point": "Adrienn", "method": "Search Dark Crystal Cave 4 Entrance"},
    "Swordsdance": {"location": "", "point": "", "method": ""},
    "Strugglebug": {"location": "Lapis Ward", "point": "Shade", "method": "Shelly Prize"},
    "Psychup": {"location": "Peridot Ward", "point": "Kiki", "method": "Search B2F Blackstream Factory"},
    "Bulldoze": {"location": "Glitch World", "point": "Ciel", "method": "T3RR4 Prize"},
    "Frostbreath": {"location": "Route 4", "point": "Hardy", "method": "Search Route 4 Lower Right Area with Mountain Field"},
    "Rockslide": {"location": "Agate City", "point": "Saphira", "method": "Hardy Prize"},
    "Xscissor": {"location": "Celestinine Cascade", "point": "Amaria", "method": "Fiore Mansion Gym Puzzle"},
    "Dragontail": {"location": "Obsidia Ward", "point": "Adrienn", "method": "Search Devon Corp 6F Bottom Right"},
    "Infestation": {"location": "Underground Railnet", "point": "Serra", "method": "Search 1F 4th Breakable Wall 5th Row"},
    "Poisonjab": {"location": "Teknite Cave", "point": "Titania", "method": "Search 3-4F Area Entrance"},
    "Dreameater": {"location": "Obsidia Ward", "point": "Adrienn", "method": "Obsidia Department Store 9F"},
    "Grassknot": {"location": "Route 3", "point": "Charlotte", "method": "LCCC Upper Side"},
    "Swagger": {"location": "Agate Circus", "point": "Samson", "method": "High Striker Prize"},
    "Sleeptalk": {"location": "Azurine Island", "point": "Aya", "method": "Search Azurine Island Left Small Path Left of Boat"},
    "Uturn": {"location": "", "point": "", "method": ""},
    "Substitute": {"location": "Onyx Ward", "point": "Florina", "method": "Game Corner Prize"},
    "Flashcannon": {"location": "Once Upon a Somewhere/Waste of Time", "point": "Amaria", "method": "Titania Prize"},
    "Trickroom": {"location": "Vanhanen Labyrinth", "point": "Subseven Sanctum", "method": "Radomus Prize"},
    "Wildcharge": {"location": "Tourmaline Desert", "point": "Titania", "method": "Search Tourmaline Desert Platform Jumping Area"},
    "Secretpower": {"location": "Byxbysion Wasteland", "point": "Serra", "method": "Search Hidden Tunnel Right Water Pool"},
    "Snarl": {"location": "Yureyu Power Plant", "point": "Luna", "method": "Yureyu Key Event"},
    "Naturepower": {"location": "Onyx Ward", "point": "Taka/Pulse Tangrowth 2", "method": "Florina Prize"},
    "Darkpulse": {"location": "Iolia Valley", "point": "Point of No Return", "method": "Luna Prize"},
    "Poweruppunch": {"location": "Teknite Ridge", "point": "Titania", "method": "Search Teknite Ridge Left Area Elevated Area"},
    "Dazzlinggleam": {"location": "Coral Ward", "point": "Titania", "method": "Adrienn Prize"},
    "Confide": {"location": "Lost Railcave", "point": "Serra", "method": "Lost Railcave Puzzle"},
    "Cut": {"location": "Obsidia Ward", "point": "ZEL/Pulse Tangrowth 1", "method": "Given by Amaria During Stroy"},
    "Fly": {"location": "Celestinine Cascade", "point": "Ciel", "method": "Given by Florina After Water Treatment Center"},
    "Surf": {"location": "Celestinine Cascade", "point": "Charlotte", "method": "Given by Titania After Samson"},
    "Strength": {"location": "Apophyll Academy", "point": "Aya", "method": "Given by Victoria After Pulse Camerupt"},
    "Waterfall": {"location": "Ametrine City", "point": "T3RR4", "method": "Given by Blake or Aster"},
    "Dive": {"location": "Agate Circus", "point": "Samson", "method": "Agate Circus Puzzle"},
    "Rocksmash": {"location": "Grand Stairway", "point": "Shelly", "method": "Given by Black Belt on Middle-Left Ledges"},
    "Flash": {"location": "Underground Railnet", "point": "Serra", "method": "Search 1F 2nd Breakable Wall"},
    "Rockclimb": {"location": "Route 4", "point": "Hardy", "method": "Given by Hardy"}
}

tutorLocations = {
    "Afteryou": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Doxy Tutor"},
    "Aircutter": {"location": "", "point": "", "method": ""},
    "Allyswitch": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Magician Tutor"},
    "Ancientpower": {"location": "", "point": "", "method": ""},
    "Aquatail": {"location": "7th Street", "point": "Adrienn", "method": "Lower Yellow Tutor"},
    "Bind": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Yellow Tutor"},
    "Blastburn": {"location": "Peridot Ward", "point": "Elite 4/Champion", "method": "Mosswater Market"},
    "Block": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Red Tutor"},
    "Bounce": {"location": "Agate Circus", "point": "Samson", "method": "Red Tutor"},
    "Bugbite": {"location": "Agate Circus", "point": "Samson", "method": "Orange Tutor"},
    "Covet": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Doxy Tutor"},
    "Defog": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Magician Tutor"},
    "Dracometeor": {"location": "Peridot Ward", "point": "Elite 4/Champion", "method": "Mosswater Market"},
    "Dragonascent": {"location": "", "point": "", "method": ""},
    "Dragonpulse": {"location": "Peridot Ward", "point": "Amaria", "method": "Mosswater Market"},
    "Drainpunch": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Drillrun": {"location": "Agate Cirucs", "point": "Samson", "method": "Red Tutor"},
    "Dualchop": {"location": "Agate Circus", "point": "Samson", "method": "Orange Tutor"},
    "Earthpower": {"location": "Peridot Ward", "point": "Hardy", "method": "Mosswater Market"},
    "Electroweb": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Doxy Tutor"},
    "Endeavor": {"location": "Agate Circus", "point": "Samson", "method": "Orange Tutor"},
    "Firepledge": {"location": "Lapis Ward", "point": "Shelly", "method": "Left of Shelly's Gym"},
    "Firepunch": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Focuspunch": {"location": "Agate Circus", "point": "Samson", "method": "Orange Tutor"},
    "Foulplay": {"location": "Peridot Ward", "point": "Amaria", "method": "Mosswater Market"},
    "Frenzyplant": {"location": "Peridot Ward", "point": "Elite 4/Champion", "method": "Mosswater Market"},
    "Furycutter": {"location": "", "point": "", "method": ""},
    "Gastroacid": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Yelllow Tutor"},
    "Gigadrain": {"location": "7th Street", "point": "Adrienn", "method": "Lower Yellow Tutor"},
    "Grasspledge": {"location": "Lapis Ward", "point": "Shelly", "method": "Left of Shelly's Gym"},
    "Gravity": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Doxy Tutor"},
    "Gunkshot": {"location": "Peridot Ward", "point": "Amaria", "method": "Mosswater Market"},
    "Headbutt": {"location": "", "point": "", "method": ""},
    "Healbell": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Heatwave": {"location": "Peridot Ward", "point": "Hardy", "method": "Mosswater Market"},
    "Helpinghand": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Yellow Tutor"},
    "Hydrocannon": {"location": "Peridot Ward", "point": "Elite 4/Champion", "method": "Mosswater Market"},
    "Hypervoice": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Icepunch": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Icywind": {"location": "Agate Circus", "point": "Samson", "method": "Orange Tutor"},
    "Irondefense": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Yellow Tutor"},
    "Ironhead": {"location": "7th Street", "point": "Adrienn", "method": "Lower Yellow Tutor"},
    "Irontail": {"location": "Agate Circus", "point": "Samson", "method": "Orange Tutor"},
    "Knockoff": {"location": "7th Street", "point": "Adrienn", "method": "Lower Yellow Tutor"},
    "Laserfocus": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Magician Tutor"},
    "Lastresort": {"location": "Agate Circus", "point": "Samson", "method": "Red Tutor"},
    "Liquidation": {"location": "7th Street", "point": "Adrienn", "method": "Lower Yellow Tutor"},
    "Lowkick": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Magiccoat": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Red Tutor"},
    "Magicroom": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Doxy Tutor"},
    "Magnetrise": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Red Tutor"},
    "Mudslap": {"location": "", "point": "", "method": ""},
    "Ominouswind": {"location": "", "point": "", "method": ""},
    "Outrage": {"location": "Peridot Ward", "point": "Hardy", "method": "Mosswater Market"},
    "Painsplit": {"location": "Agate Circus", "point": "Samson", "method": "Orange Tutor"},
    "Recycle": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Red Tutor"},
    "Relicsong": {"location": "", "point": "", "method": ""},
    "Roleplay": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Yellow Tutor"},
    "Rollout": {"location": "", "point": "", "method": ""},
    "Secretsword": {"location": "", "point": "", "method": ""},
    "Seedbomb": {"location": "Peridot Ward", "point": "Amaria", "method": "Mosswater Market"},
    "Shockwave": {"location": "Agate Circus", "point": "Samson", "method": "Red Tutor"},
    "Signalbeam": {"location": "7th Street", "point": "Adrienn", "method": "Lower Yellow Tutor"},
    "Skillswap": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Yellow Tutor"},
    "Skyattack": {"location": "Agate Circus", "point": "Samson", "method": "Red Tutor"},
    "Snatch": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Doxy Tutor"},
    "Snore": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Yellow Tutor"},
    "Spite": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Red Tutor"},
    "Stealthrock": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Stompingtantrum": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Stringshot": {"location": "", "point": "", "method": ""},
    "Suckerpunch": {"location": "", "point": "", "method": ""},
    "Superfang": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Superpower": {"location": "Peridot Ward", "point": "Hardy", "method": "Mosswater Market"},
    "Swift": {"location": "", "point": "", "method": ""},
    "Synthesis": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Tailwind": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Telekinesis": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Magician Tutor"},
    "Throatchop": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Thunderpunch": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"},
    "Trick": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Red Tutor"},
    "Twister": {"location": "", "point": "", "method": ""},
    "Uproar": {"location": "Agate Circus", "point": "Samson", "method": "Red Tutor"},
    "Vacuumwave": {"location": "", "point": "", "method": ""},
    "Volttackle": {"location": "North Aventurine Woods", "point": "Radomus", "method": "NyuF"},
    "Waterpledge": {"location": "Lapis Ward", "point": "Shelly", "method": "Left of Shelly's Gym"},
    "Waterpulse": {"location": "Agate Circus", "point": "Samson", "method": "Red Tutor"},
    "Wonderroom": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Doxy Tutor"},
    "Worryseed": {"location": "7th Street", "point": "Subseven Sanctum", "method": "Red Tutor"},
    "Zenheadbutt": {"location": "Peridot Ward", "point": "Adrienn", "method": "Mosswater Market"}
}
...
def getName(name, mapNo):
    return f"{name} (Alolan)" if alolanExclusion(name, mapNo) else name.capitalize()
...
for head, pk in pokemonData.items():
    if len(contents) > 74 or int(head) in [152, 252, 387, 494, 650, 722]:
        with open(f'gen{gen}_{subgen}.ts', 'w+') as f:
            f.write(
                f"export const pokemonData{gen}{subgen} = {json.dumps(contents)}")
            contents = []
...
with open(f'gen{gen}_{subgen}.ts', 'w+') as f:
    f.write(f"export const pokemonData{gen}{subgen} = {json.dumps(contents)}")
